...
class SortingAlgorithmsGUI {
    ...
    private void setupLayout() {
        rootPanel.add(listOptionsPanel, new GridBagConstraints(0, 0, GridBagConstraints.REMAINDER, 1, 0.1, 0.001, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        rootPanel.add(resultsPanel, new GridBagConstraints(0, 1, GridBagConstraints.REMAINDER, GridBagConstraints.REMAINDER, 0.1, 0.1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

        listOptionsPanel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Choose List Properties"),
                BorderFactory.createEmptyBorder(5, 5, 5, 5)));
        listOptionsPanel.add(listDropDown, new GridBagConstraints(0, 0, 1, 1, 0.1, 0.1, GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        listOptionsPanel.add(listSlider, new GridBagConstraints(0, 1, 1, 1, 0.1, 0.1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        listOptionsPanel.add(listText, new GridBagConstraints(1, 1, GridBagConstraints.REMAINDER, 1, 0.01, 0.1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        listOptionsPanel.add(listButton, new GridBagConstraints(0, 2, GridBagConstraints.REMAINDER, GridBagConstraints.REMAINDER, 0.1, 0.1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
